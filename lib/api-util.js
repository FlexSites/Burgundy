...
export function getData(resource, id, req = {}, parent = {}) {
  var isList = !id;
  ...
  if (!~modelKeys.indexOf(key)) return Promise.resolve(isList ? [] : {});
